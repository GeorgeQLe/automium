...
- Recruit initial alpha design partners using owned or consented applications only. _(after: Step 8.2)_
- Provision production-like alpha environments and scoped secrets for benchmark execution. _(blocks: Step 8.3)_
- Approve the cross-model benchmark report format and the alpha success gate for repeatability, latency, recovery, and spend. _(after: Step 8.4)_
