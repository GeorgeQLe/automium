...
- Recruit initial alpha design partners once owned-product benchmark journeys are stable. _(after: Step 7.6)_
- Provision production-like alpha environments and scoped secrets for benchmark execution across owned products. _(blocks: Step 7.7)_
- Approve the cross-model benchmark report format and the alpha success gate for repeatability, latency, recovery, and spend. _(after: Step 7.7)_
