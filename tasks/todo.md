...
## Active Task: Devtool Adoption

Goal: create `research/devtool-adoption.md` using the installed `devtool-adoption` skill.

### Plan

- [x] Read the `devtool-adoption` skill instructions.
- [x] Review existing user, integration, DX journey, benchmark, spec, and spec-drift context.
- [x] Map adoption loops, examples, templates, community channels, proof artifacts, activation metrics, risks, and backlog.
- [x] Create `research/devtool-adoption.md`.
...
- [ ] Run `$devtool-positioning` from the priority documentation queue.

### Next Step Implementation Plan

1. Read the `devtool-positioning` skill instructions and existing research artifacts.
2. Create `research/devtool-positioning.md` covering positioning against alternatives by workflow, ecosystem, trust, and switching cost for Automium.
